                    ...
                    <div className="sm:block hidden">
                        <div className="grid grid-cols-12 gap-5">
                            ...
                            <div className="col-span-5">
                                <div className={isHomePage ? 'card bg-[#0E80FC] rounded-[15px] px-7 py-10 relative h-full' : `card bg-[#0E80FC] rounded-[15px] px-7 py-10 relative h-full ${cardTwo.css} overflow-hidden`}>
                            ...
                            <div className="col-span-7">
                                <div className={`card bg-gradient-to-t from-[#AA00FE] to-[#6B00FE] rounded-[15px] px-7 py-10 h-full relative ${cardFour.cardCss}`}>
                        ...
                        {isHomePage ?
                            ...
                            <div className='grid grid-cols-12 mt-5'>
                                <div className="col-span-12">
                                    <div className="card bg-gradient-to-t from-[#FF2D4B] to-[#F5090B] rounded-[15px] px-7 py-10 relative h-full">
